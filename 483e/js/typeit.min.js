...
new TypeIt('#example3', {
    strings: ["<a href='#About' class='color_white under'>who I am.</a>", 
              "<a href='#Philosophy' class='color_white under'>my design philosophy.</a>",
             "<a href='#Process' class='color_white under'>my design process.</a>",
             "<a href='#Apps' class='color_white under'>my favorite apps.</a>",
             "<a href='#Likes' class='color_white under'>what I like to do.</a>"],
    breakLines: false,
    nextStringDelay: [1,5000],
    loop: true,
    speed: 40,
    startDelay: 8000
})    
