...
new TypeIt('#example3', {
    strings: ["<a href='#About' class='color_white under'>who I am.</a>", 
             ...
             "<a href='#' class='color_white under'>my design process.</a>",
             "<a href='#' class='color_white under'>my favorite apps.</a>",
             "<a href='#' class='color_white under'>what I like to do.</a>"],
    breakLines: false,
    nextStringDelay: [1,50000],
    loop: true,
    speed: 40,
    startDelay: 8000
})    
